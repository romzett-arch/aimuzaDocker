-- ═══════════════════════════════════════════════════════════════
-- 035-qa-xp-fallback.sql
-- Исправление: при подтверждении баг-репорта рубли начисляются, XP — нет.
-- Причина: админ/баунти задаёт rewardCredits, но rewardXp=0.
-- Решение: если credits > 0, а xp = 0 — брать XP из qa_config.rewards по severity.
-- ═══════════════════════════════════════════════════════════════
