-- Escrow only for lyrics. Prompts and beats sell instantly.
-- Lyrics: admin_status = 'pending_review', seller_earnings.status = 'pending', no seller balance update
-- Prompts/beats: admin_status = 'approved', seller_earnings.status = 'available', seller gets money immediately
