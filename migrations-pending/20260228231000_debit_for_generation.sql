-- Серверная валидация цены генерации.
-- RPC рассчитывает сумму на бэкенде (generation_price + addons) с учётом скидки подписчика.
-- Заменяет вызов debit_balance с фронтовой суммой.
...
COMMENT ON FUNCTION public.debit_for_generation IS 'Списание за генерацию с серверной валидацией цены. Учитывает generation_price, subscriber_discount и addon_services.';
