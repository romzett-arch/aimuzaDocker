-- Add deposit_method to get_marketplace_items for lyrics items
-- Must DROP first when changing return type (adding column)
...
GRANT EXECUTE ON FUNCTION public.get_marketplace_items(TEXT) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_marketplace_items(TEXT) TO anon;
