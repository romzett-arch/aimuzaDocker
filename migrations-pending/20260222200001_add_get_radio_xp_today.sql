-- get_radio_xp_today: returns XP earned today for a given user
-- Called by useRadioStream on initial load
...
GRANT EXECUTE ON FUNCTION public.get_radio_xp_today(UUID) TO authenticated;
