...
const ALLOWED_RPC = new Set([
  ...
  'generate_share_token', 'get_ad_for_slot', 'get_public_ad_settings', 'request_ad_for_slot', 'get_boosted_tracks', 'get_track_boost_state', 'get_my_active_track_boosts',
  ...
  'get_importable_prompt_track_ids', 'get_user_prompt_stats', 'get_user_stats', 'get_user_subscription_tier', 'get_user_vote_weight',
  ...
  'hide_contest_comment', 'hide_track_comment',
  'increment_prompt_downloads', 'increment_track_download_count',
  ...
  'messaging_create_admin_conversation', 'messaging_create_direct_conversation',
  'messaging_get_conversations', 'messaging_get_direct_message_state', 'messaging_get_messages',
  'messaging_get_notification_payload', 'messaging_get_unread_count', 'messaging_mark_read',
  ...
  'process_store_item_purchase', 'purchase_ad_free', 'purchase_track_boost', 'rename_my_release_track',
  'begin_track_deposit', 'fail_track_deposit_and_refund',
  'record_feed_listen', 'record_lyrics_blockchain_deposit', 'record_track_promotion_event', 'register_referral',
