...
export const STATIC_SEO_PAGES: StaticSeoPageDefinition[] = [
  {
    pageKey: "home",
    path: "/",
    title: "AIMUZA: социальная сеть AI-музыкантов и релизы через НОТА-ФЕЯ",
    description: "Публикуйте треки, развивайте профиль артиста, находите слушателей и выпускайте музыку на цифровые площадки через лейбл НОТА-ФЕЯ.",
    priority: 1,
    changefreq: "daily",
    indexable: true,
    pageType: "landing",
    intent: "Главный вход в социальную платформу для AI-музыкантов: профили артистов, публикация треков, комьюнити и дистрибуция через НОТА-ФЕЯ.",
  },
  {
    pageKey: "catalog",
    path: "/catalog",
  ...
  },
  {
    pageKey: "contests",
    path: "/contests",
    title: "Конкурсы AI-музыкантов и артистов AIMUZA",
  ...
  },
  {
    ...
    description: "Изучите тарифы AIMUZA для артистов: публикация треков, AI-инструменты, депонирование, продвижение и дистрибуция релизов.",
    priority: 0.6,
    changefreq: "weekly",
    indexable: true,
    pageType: "legal",
